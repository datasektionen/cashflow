...
@register
class FortnoxRecordMissingError(exceptions.APIException, FortnoxDomainError):
...
@register
class CashflowVerificationMissingError(exceptions.APIException, FortnoxDomainError):
    status_code = status.HTTP_409_CONFLICT
...
@register
class AlreadyAccountedError(exceptions.APIException, FortnoxDomainError):
    status_code = status.HTTP_409_CONFLICT
