        ...
        <RadioGroup.Root class="flex flex-col gap-4 text-sm">
            <div class="flex flex-row items-center space-x-2">
                <RadioGroup.Item
                        ...
                        value="paid-no"
                        class={[
                            "inset-shadow-xs border border-base-800 bg-base-500",
                            "data-[state=checked]:border-money-green-500 data-[state=checked]:border-4 data-[state=checked]:bg-white",
                            "size-4 cursor-pointer",
                            "dark:border-dark-base-50 dark:bg-dark-base-200",
                            "dark:data-[state=checked]:bg-dark-base-200"
                        ]}
                />
                <Label.Root for="paid-no">
                    Nej, sektionen ska göra det
                </Label.Root>
            ...
            <div class="flex flex-row items-center space-x-2">
                ...
                />
                <Label.Root for="paid-yes">
                    Ja, från sektionens konto
                </Label.Root>
            </div>
