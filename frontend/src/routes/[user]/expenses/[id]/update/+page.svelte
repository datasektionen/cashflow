<script lang="ts">
    ...
    const partsLocked = $derived(expense.parts.some((p) => p.attested_by != null));
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <div class="flex flex-wrap gap-2 bg-base-300 p-2 dark:bg-dark-base-300 justify-between">
                        {#each expense.files as file}
                            ...
                            >
                                <FileThumbnail source={file.file} engine={pdfium.engine}
                                ...
                                <button
                                        ...
                                        onclick={isDeleted? () => deletedFiles.delete(file.id): () => deletedFiles.add(file.id)}
                                >
                                    {#if isDeleted}
                                        <Undo2/>
                                    {:else}
