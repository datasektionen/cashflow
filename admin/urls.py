...
urlpatterns += [
    ...
    re_path(
        r"^expense/(?P<expense_pk>\d+)/verification/$",
        views.set_verification,
        name="admin-expense-verification",
    ),
    re_path(
        r"^expense/(?P<pk>\d+)/confirm/$",
        views.confirm_expense,
        name="admin-expense-confirm",
    ),
    re_path(
        r"^expense/(?P<pk>\d+)/unconfirm/$",
        views.unconfirm_expense,
        name="admin-expense-unconfirm",
    ),
    re_path(
        r"^invoice/(?P<invoice_pk>\d+)/verification/$",
        views.invoice_set_verification,
        name="admin-invoice-verification",
    ),
    re_path(
        r"^expense-part/(?P<pk>\d+)/attest/$",
        views.attest_expense_part,
        name="admin-expensepart-attest",
    ),
    re_path(
        r"^expense-part/(?P<pk>\d+)/unattest/$",
        views.unattest_expense,
        name="admin-expense-unattest",
    ),
    re_path(
        r"^invoice-part/(?P<pk>\d+)/attest/$",
    ...
    re_path(
        r"^verifications/$", views.search_verification, name="admin-search-verification"
    ),
    re_path(
        r"^verifications/search/$",
        views.search_verification_response,
        name="admin-search-verification-api",
    ),
    re_path(
        r"^verifications/list$", views.list_verification, name="admin-list-verification"
    ),
